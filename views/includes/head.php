<link rel="icon" href="<?= htmlspecialchars($dir); ?>img/resources/favicon.ico" type="image/x-icon">
<meta charset="UTF-8">
...
<script src="<?= htmlspecialchars($dir); ?>js/main.js"></script>

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-140402227-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-140402227-4');
</script>
